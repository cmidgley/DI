 ...
 */
function evaluate({ typeChecker, node, environment: { preset = "NODE", extra = {} } = {}, typescript = TSModule__namespace, logLevel = 0 /* SILENT */, policy: { deterministic = false, network = false, console = false, maxOps = Infinity, maxOpDuration = Infinity, io = {
    read: true,
    write: false
}, process = {
    exit: false,
